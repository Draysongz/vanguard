    ...
    <div className="app">
      ...
      <nav className="navbar">
        <div className="nav-container">
          <div className="brand">
            <img src="https://peach-ready-eel-101.mypinata.cloud/ipfs/bafybeidr7fk6ilt7utl4qv5olt3iomu4kwm27j3eotdzhjpt3svckrx7ce/Oreva.png" alt="Vanguard Logo" width={70} />
